...
<header>
    ...
    <a href="#" class="logo"><img src="images/20221219_172300_0000.png" alt=""></a>
...
<section class="home" id="home">
    ...
    <div class="content" data-aos="fade-right">
        <h3>Welcome to </h3>
        <h3><span style="color: var(--yellow);" >ShivJyot</span></h3>
               <p>Pet Integrated Farm</p>
        <a href="#"><button class="btn">get started</button></a>
    </div>

    <div class="image" data-aos="fade-up">
        <img src="images/goat4.jpeg" alt="">
    </div>
